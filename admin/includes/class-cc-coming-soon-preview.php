...
class CcComingSoonPreview {
                ...
                array(
                    ...
                    'fields' => array(
                        ...
                        array(
                            ...
                            'action' => 'text',
                            'name'   => 'checkbox_label',
                            'target' => '#newsletter .cc-cs-form-control__checkbox-text',
                            'desc'   => 'Checkbox label:',
                        ),
                    ),
                ),
            ...
            'field_groups' => array(
                ...
                array(
                    ...
                    'fields'       => array(
                        array(
                            'type'   => 'font',
                            'name'   => 'checkbox_label_font',
                            'target' => '.cc-cs-form-control__checkbox-text',
                            'attr'   => 'font-family',
                            'desc'   => 'Checkbox Label Font:',
                        ),
                        array(
                            'type'   => 'color_picker',
                            ...
                            'target' => '.cc-cs-form-control__checkbox-text',
                            'attr'   => 'color',
                            'desc'   => 'Checkbox Label Color:',
                        ),
                        array(
                            'type'   => 'color_picker',
                            'name'   => 'checkbox_border_color',
                            'target' => '.cc-cs-form-control__checkmark',
                            'attr'   => 'border-color',
                            'desc'   => 'Checkbox Border Color:',
                        ),
                        array(
                            'type'   => 'color_picker',
                            'name'   => 'checkbox_checkmark_color',
                            'target' => '.cc-cs-form-control__checkmark-before,.cc-cs-form-control__checkmark-after',
                            'attr'   => 'background',
                            'desc'   => 'Checkbox Checkmark Color:',
                        ),
                    ),
                ),
                array(
    ...
    private  function build_field_upload($field, $options_group) {
        ...
        $option_html .= '<input
                        ...
                        name="'.$name .'"
                        id="'.$id .'"
                        value = "'.$this->build_field_values($field, $options_group).'"
                        class="cc-pu-customize-style"
                        data-customize-target="'.$field['target'].'"
                        data-attr="'.$field['attr'].'"
                        data-template="'.$template.'"
    ...
    private function build_field_font($field, $options_group) {
        ...
        if(!empty($fonts)):
            foreach($fonts as $val => $desc):
                $selected = '';
                if(isset($options[$field['name']]) && $options[$field['name']] == $val){
                        $selected = 'selected';
                }
                $option_html .= '<option value="'.$val.'" '.$selected.'>'.$desc.'</option> ';
            endforeach;
    ...
    private function build_field_editor($field, $options_group) {
        ...
        $settings = array(
            ...
            'textarea_name' => $name,
            'tinymce' => array(
                'toolbar1'=> ', formatselect,bold,italic,underline,link,unlink,forecolor,undo,redo',
                'toolbar2'=> '',
                'toolbar3'=> ''
            )
        );
